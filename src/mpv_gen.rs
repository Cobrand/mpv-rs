...
extern "C" {
    ...
    #[link_name = "\u{1}mpvmpv_client_api_version"]
    ...
    #[link_name = "\u{1}mpvmpv_error_string"]
    ...
    #[link_name = "\u{1}mpvmpv_client_name"]
    ...
    #[link_name = "\u{1}mpvmpv_client_id"]
    ...
    #[link_name = "\u{1}mpvmpv_initialize"]
    ...
    #[link_name = "\u{1}mpvmpv_terminate_destroy"]
    ...
    #[link_name = "\u{1}mpvmpv_create_client"]
    ...
    #[link_name = "\u{1}mpvmpv_create_weak_client"]
    ...
    #[link_name = "\u{1}mpvmpv_load_config_file"]
    ...
    #[link_name = "\u{1}mpvmpv_get_time_us"]
    ...
    #[link_name = "\u{1}mpvmpv_free_node_contents"]
    ...
    #[link_name = "\u{1}mpvmpv_set_option"]
    ...
    #[link_name = "\u{1}mpvmpv_set_option_string"]
    ...
    #[link_name = "\u{1}mpvmpv_command_node"]
    ...
    #[link_name = "\u{1}mpvmpv_command_ret"]
    ...
    #[link_name = "\u{1}mpvmpv_command_string"]
    ...
    #[link_name = "\u{1}mpvmpv_command_async"]
    ...
    #[link_name = "\u{1}mpvmpv_command_node_async"]
    ...
    #[link_name = "\u{1}mpvmpv_abort_async_command"]
    ...
    #[link_name = "\u{1}mpvmpv_set_property"]
    ...
    #[link_name = "\u{1}mpvmpv_set_property_string"]
    ...
    #[link_name = "\u{1}mpvmpv_set_property_async"]
    ...
    #[link_name = "\u{1}mpvmpv_get_property"]
    ...
    #[link_name = "\u{1}mpvmpv_get_property_string"]
    ...
    #[link_name = "\u{1}mpvmpv_get_property_osd_string"]
    ...
    #[link_name = "\u{1}mpvmpv_get_property_async"]
    ...
    #[link_name = "\u{1}mpvmpv_observe_property"]
    ...
    #[link_name = "\u{1}mpvmpv_unobserve_property"]
    ...
    #[link_name = "\u{1}mpvmpv_event_name"]
    ...
    #[link_name = "\u{1}mpvmpv_event_to_node"]
    ...
    #[link_name = "\u{1}mpvmpv_request_event"]
    ...
    #[link_name = "\u{1}mpvmpv_request_log_messages"]
    ...
    #[link_name = "\u{1}mpvmpv_wait_event"]
    ...
    #[link_name = "\u{1}mpvmpv_set_wakeup_callback"]
    ...
    #[link_name = "\u{1}mpvmpv_wait_async_requests"]
    ...
    #[link_name = "\u{1}mpvmpv_hook_continue"]
    ...
    #[link_name = "\u{1}mpvmpv_get_wakeup_pipe"]
    ...
    #[link_name = "\u{1}mpvmpv_render_context_create"]
    ...
    #[link_name = "\u{1}mpvmpv_render_context_set_parameter"]
    ...
    #[link_name = "\u{1}mpvmpv_render_context_get_info"]
    ...
    #[link_name = "\u{1}mpvmpv_render_context_set_update_callback"]
    ...
    #[link_name = "\u{1}mpvmpv_render_context_update"]
    ...
    #[link_name = "\u{1}mpvmpv_render_context_render"]
    ...
    #[link_name = "\u{1}mpvmpv_render_context_report_swap"]
    ...
    #[link_name = "\u{1}mpvmpv_render_context_free"]
